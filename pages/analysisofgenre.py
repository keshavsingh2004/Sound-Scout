...
# Plot the genre distribution in a pie chart using Streamlit
fig, ax = plt.subplots(figsize=(12, 6))
ax.pie(top_genres, labels=top_genres.index, autopct='%1.1f%%', startangle=90)
ax.axis('equal')
ax.set_title('Genre Distribution')
total_genres = len(genre_counts)
ax.text(0, -1.3, f"Total Genres: {total_genres}", horizontalalignment='center', verticalalignment='center')
