...
goto_page("🎶 Analysis of Songs", "pages/analysis.py")
...
goto_page("🎤 Top Artists", "pages/top_5.py")
...
goto_page("🎧 Genre Analysis", "pages/analysisofgenre.py")
...
goto_page("🔍 Genre Prediction", "pages/linear.py")