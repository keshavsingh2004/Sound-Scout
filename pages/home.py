...
goto_page("Go to Analysis of Songs", "pages/analysis.py")
...
goto_page("Go to Top Artists", "pages/top_5.py")
...
goto_page("Go to Genre Analysis", "pages/analysisofgenre.py")
...
goto_page("Go to Genre Prediction", "pages/linear.py")