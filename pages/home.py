...
.retrobg-mountain {
	...
	width: 30%;
	height: 100%;
	background-image: linear-gradient(#0007 0%, #11185 0%, #fff1);
}
...
.retrobg-building {
	...
	height: 100%;
	bottom: 0;
	border-radius: Here's the rest of the corrected code:

```python
4px 4px 0 0;
	background-image: linear-gradient(0deg, rgba(17, 17, 34, 0), #1123 0px, #000);
}

.retrobg-building:nth-child(odd) {
	background-image: linear-gradient(0deg, rgba(24, 24, 42, 0), #2233 0px, #000);
}
...
#retrobg-groundShadow {
	...
	width: 100%;
	height: 100%;
	background-image: linear-gradient(#0000 0%, transparent);
}
